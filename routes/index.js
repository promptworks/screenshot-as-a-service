...
module.exports = function(app, useCors) {
  ...
  var processRequest = function(req, res, next) {
    ...
    ['width', 'height', 'clipRect', 'javascriptEnabled', 'loadImages', 'localToRemoteUrlAccessEnabled', 'userAgent', 'userName', 'password', 'delay', 'zoomFactor', 'pdfPaperSize', 'pdfOrientation'].forEach(function(name) {
